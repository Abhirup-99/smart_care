...
class main:
	...
	def define(self,master):
		...
		self.label4=Label(master,text="weight(in kg)")
		self.label5=Label(master,text="systolic pressure")
		self.label6=Label(master,text="diastolic pressure")
		self.label7=Label(master,text="cholestrol levels(1: normal, 2: above normal, 3: well above normal)")
		self.label8=Label(master,text="glucose levels(1: normal, 2: above normal, 3: well above )")
		self.label9=Label(master,text="smoke(1= smoke , 0=non smoker)")
		self.label10=Label(master,text="alcoholic(1= YES , 0=NO)")
